    ...
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0">&copy; {{ date('Y') }}. All rights reserved.</li>
              
                <li class="lg:ml-6">
                    <a href="{{ URL::to('sitemap.xml') }}" class="relative inline-block text-black group">
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                <li>
                    <a href="https://facebook.com/kashifcoder" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://instagram.com/root_kashif" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://twitter.com/Darkcoder1" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://github.com/DarkcoderSe" class="text-gray-600 hover:text-gray-900">
